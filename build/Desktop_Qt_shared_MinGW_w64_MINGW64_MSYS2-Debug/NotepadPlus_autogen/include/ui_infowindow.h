...
public:
    ...
    void setupUi(QMainWindow *InfoWindow)
    {
        ...
        label_2->setGeometry(QRect(100, 220, 231, 41));
        QFont font1;
    ...
    void retranslateUi(QMainWindow *InfoWindow)
    {
        ...
        label->setText(QCoreApplication::translate("InfoWindow", "<html><head/><body><p align=\"center\"><a style=\"text-decoration: none\" href=\"https://github.com/Syneation/notepad-plus\"><span style=\" color:black;\">FusionNote</span></a></p></body></html>", nullptr));
        label_2->setText(QCoreApplication::translate("InfoWindow", "version: 1.0 (pre-release)", nullptr));
        ...
        label_5->setText(QCoreApplication::translate("InfoWindow", "FusionNote is designed for quick notes or anything with advanced features. Enjoy :)", nullptr));
